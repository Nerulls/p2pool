...
BLOCK_EXPLORER_URL_PREFIX='http://blockexplorer.lavajumper.com/block/'
ADDRESS_EXPLORER_URL_PREFIX='http://blockexplorer.lavajumper.com/address/'
TX_EXPLORER_URL_PREFIX='http://blockexplorer.lavajumper.com/tx/'
